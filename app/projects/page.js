  ...
  return (
    <div className="my-5">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 mt-5 gap-2">
        <ProjectLink link="/projects/calculator" title="Calculator" body="My straightforward calculator project. A simple traditional JS Project" />
        <ProjectLink link="/projects/tictactoe" title="Tic Tac Toe" body="Playful challenge awaits! Check out my tic-tac-toe project" />
      </div>
    </div>
  )
}
